...
if(GBM_FOUND)
  ...
  execute_process(COMMAND bash -c "dpkg -L libgbm-dev | grep libgbm.so$" OUTPUT_VARIABLE GBM_LIBRARIES OUTPUT_STRIP_TRAILING_WHITESPACE)
  execute_process(COMMAND bash -c "dirname $(dpkg -L libgbm-dev | grep gbm.h$)" OUTPUT_VARIABLE GBM_INCLUDE_DIRS OUTPUT_STRIP_TRAILING_WHITESPACE)
  execute_process(COMMAND bash -c "dpkg -s libgbm-dev | grep Version | cut -d ' ' -f2" OUTPUT_VARIABLE GBM_VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
endif()
